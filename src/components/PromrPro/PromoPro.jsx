...
const Pomofocus = () => {
  ...
  const promodoroTimerRef = useRef(null);
    ...
    <Provider store={store}>
      <div>
        <Navbar
          ...
          scrollToRefs={{
            promodoroTimer: promodoroTimerRef,
            taskManager: taskManagerRef,
            speechToText: speechToTextRef,
  ...
  <Route
    ...
    element={
      <div>
        <div id="promodoro-timer" ref={promodoroTimerRef}>
        ...
        <div ref={speechToTextRef} id="speech-to-text" >
          <div className="speech">
            <Speech />
          </div>
        </div>
        <div id="music-player" ref={musicPlayerRef}>
          <div id="music">
            <Audioplayer/>
          </div>
        </div>
